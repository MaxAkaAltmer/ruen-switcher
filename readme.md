...
Легковесный, умный и молниеносный корректор опечаток и раскладки клавиатуры. Утилита автоматически или принудительно исправляет текст, набранный в неверной раскладке (аналог Punto Switcher, Caramba Switcher).
